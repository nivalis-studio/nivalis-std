 ...
 * @param {number} [step] - The step size between the start of each window. Must be a positive integer.
 * @param {WindowedOptions} [options] - Options object to configure the behavior of the function.
 * @param {boolean} [options.partialWindows] - Whether to include partial windows at the end of the array.
