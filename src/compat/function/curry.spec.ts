...
describe('curry', () => {
  ...
  it('should use `this` binding of function', () => {
    ...
    expect(bind(curry(fn), object)('a')('b')('c')).toEqual(
      Array.from({ length: 3 }),
    );
    expect(bind(curry(fn), object)('a', 'b')('c')).toEqual(
      Array.from({ length: 3 }),
    ...
    expect(object.curried('a')('b')('c')).toEqual(Array.from({ length: 3 }));
    expect(object.curried('a', 'b')('c')).toEqual(Array.from({ length: 3 }));
  ...
  it('should work with partialed methods', () => {
    ...
    const b = bind(a, null, 2);
    const c = partialRight(b, 4);
    const d = partialRight(b(3), 4);
