 ...
 * @param {number} [fromIndex] - The index to start searching from. If negative, it is treated as an offset from the end of the array.
 ...
 */
export function includes<T extends { [key: string]: any }>(
  obj: T,
  value: T[keyof T],
  fromIndex?: number,
): boolean;
 ...
 * @param {number} [fromIndex] - The index to start searching from. If negative, it is treated as an offset from the end of the string.
 ...
 * @param {number} [fromIndex] - The index to start searching from. If negative, it is treated as an offset from the end of the source.
 ...
 */
export function includes<T>(
  source: readonly T[] | { [key: string]: any } | string,
  target?: T,
  fromIndex?: number,
): boolean;
 ...
 */
export function includes(
  source: readonly unknown[] | { [key: string]: any } | string,
  target?: unknown,
  fromIndex?: number,
  guard?: unknown,
): boolean {
