...
describe('difference', () => {
  ...
  it(`should match \`NaN\``, () => {
    expect(difference([1, Number.NaN, 3], [Number.NaN, 5, Number.NaN])).toEqual(
      [1, 3],
    );
  });
  ...
  it(`should work with large arrays of \`NaN\``, () => {
    ...
    expect(difference([1, Number.NaN, 3], largeArray)).toEqual([1, 3]);
  });
  ...
  it(`should work with large arrays of objects`, () => {
    ...
    expect(difference([object1, object2], largeArray)).toEqual([
      object1,
      object2,
    ]);
  });
