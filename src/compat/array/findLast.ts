 ...
 * @param {number} [fromIndex] - The index to start the search from, defaults to arr.length-1.
 ...
 * @param {number} [fromIndex] - The index to start the search from, defaults to Object.keys(object).length-1.
 ...
 */
export function findLast<T extends { [key: string]: unknown }>(
