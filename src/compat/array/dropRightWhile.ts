...
export function dropRightWhile<T>(
  arr: ArrayLike<T> | null | undefined,
  propertyToDrop: [keyof T, unknown],
): T[];
...
export function dropRightWhile<T>(
  ...
  return dropRightWhileImpl([...arr], predicate);
}
...
function dropRightWhileImpl<T>(
  ...
  switch (typeof predicate) {
    case 'function': {
      return dropRightWhileToolkit(arr, (item, index, arr) =>
        Boolean(predicate(item, index, arr)),
      );
    }
