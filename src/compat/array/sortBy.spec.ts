...
describe('sortBy', () => {
  ...
  it(`should sort multiple properties in ascending order`, () => {
    ...
    expect(sortBy(objects, 'a', 'b')).toEqual([
      objects[2],
      objects[0],
      objects[3],
      objects[1],
  ...
  it(`should support iteratees`, () => {
    ...
    expect(actual).toEqual([objects[2], objects[0], objects[3], objects[1]]);
    expect(sortBy(objects, 'a', object => object.b)).toEqual([
      objects[2],
      objects[0],
      objects[3],
      objects[1],
  ...
  it(`should work as an iteratee for methods like \`_.reduce\``, () => {
    ...
    expect(['a'].reduce(sortBy, objects)).toEqual([
      objects[0],
      objects[2],
      objects[1],
      objects[3],
    ]);
    expect([0].reduce(sortBy, objects)).toEqual([
      objects[2],
      objects[3],
      objects[0],
      objects[1],
  ...
  it('should sort in ascending order by `iteratee`', () => {
    expect(sortBy(objects, object => object.b).map(object => object.b)).toEqual(
      [1, 2, 3, 4],
    );
  });
  ...
  it('should work with `_.property` shorthands', () => {
    expect(
      sortBy({ ...objects, undefined }, 'b').map(object => object?.b),
    ).toEqual([1, 2, 3, 4, undefined]);
  });
