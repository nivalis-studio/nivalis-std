...
describe('mergeWith', () => {
  ...
  it('should return an object when the target is a primitive', () => {
    expect(mergeWith(1, null, noop)).toEqual(new Object(1));
    expect(mergeWith('a', null, noop)).toEqual(new Object('a'));
    expect(mergeWith(true, null, noop)).toEqual(new Object(true));
